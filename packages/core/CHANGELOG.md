...
- 1931dd8: `@nubbin/core` exports `checkCompatibility`, which answers the question the whole publish model
...
- a79f39a: `createRegistry` resolves every slot `allow` entry against the blocks it holds and throws on one
