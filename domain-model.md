...
Every entity, what owns it, and where it lives across the three layers. Types here are
pseudocode — illustrative shape, not the final signatures.
...
field path — see [`02-api-sketch.md`](api-sketch.md#where-ui-hints-live) for the decision
...
[data lifecycle](api-sketch.md#data-lifecycle-is-a-field-hint-not-a-block-flag) in
`02-api-sketch.md`.
...
[data lifecycle](api-sketch.md#data-lifecycle-is-a-field-hint-not-a-block-flag).
