...
## What v1 refuses, permanently

Not deferred — these are "never", and the distinction matters:
...
- **Templates that generate many routes from bound state.** Those stay coded routes;
  repetition belongs in components.
- **Executable content**, per the decision above.
